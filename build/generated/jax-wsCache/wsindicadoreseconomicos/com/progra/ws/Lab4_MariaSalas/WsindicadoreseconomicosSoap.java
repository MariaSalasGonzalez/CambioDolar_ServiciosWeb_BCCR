...
public interface WsindicadoreseconomicosSoap {
     ...
     * @param token
     * @return
     *     returns com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult
     */
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicos", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicos")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicosResponse")
    public com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult obtenerIndicadoresEconomicos(
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicosXML", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicosXML")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosXMLResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "com.progra.ws.Lab4_MariaSalas.ObtenerIndicadoresEconomicosXMLResponse")
